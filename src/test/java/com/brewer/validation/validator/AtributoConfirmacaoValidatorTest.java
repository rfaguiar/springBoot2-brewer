...
public class AtributoConfirmacaoValidatorTest {
    ...
    public void testeMetodoIsValidQuandoValoresSenhaNaoIgualComSenhaDeConfirmacaoDeveRetornarFalse() {
        ...
        Mockito.when(mockConstraintValidatorContext.buildConstraintViolationWithTemplate(ArgumentMatchers.any())).thenReturn(mockConstraintBuilationBuilder);
        Mockito.when(mockConstraintBuilationBuilder.addPropertyNode(ArgumentMatchers.any())).thenReturn(mockNodeBuilderCustomizeContext);
